...
main <- function()
{
    #list.h7.caseb <<- files2df("~/expdata/h7.caseb")
    #save(list.h7.caseb, file="list.h7.caseb.Rdata")
    #load(file="list.h7.caseb.Rdata", globalenv())

    #dfglb <<- list.h7.caseb[['_extstatssum']]
    #fdist_meta_data_blocks(list.h7.caseb[['_extstatssum']])
    #fdist_free_space_hist2(df=list.h7check01[['_freeblocks']])
    fdist_free_space_hist2(rfile="h7check01.freespacehist.Rdata")
